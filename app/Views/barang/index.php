      ...
      <tbody>
        ...
        <?php foreach ($barang as $m) : ?>
          <tr>
            ...
            <td>
              <a href="barang/edit/<?= $m['kode_barang']; ?>" class="btn btn-success btn-sm">Ubah<i class="bi bi-pencil-square"></i></a> | <a href="/barang/delete/<?= $m['kode_barang']; ?>" class="btn btn-danger btn-sm" onClick="return confirm('yakin mau hapus data <?= $m['nama_barang']; ?>'); ">Delete<i class="bi bi-calendar-x"></i></a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
